...
def config_parser(cmd=None):
    ...
    parser.add_argument("--is_toyEx", type=float, default=0.0,
                        help='is_toyEx')
    ...
    # view exclude
    parser.add_argument("--view_exclude", type=int, default=0)
    parser.add_argument("--view_exclude_list", nargs="+", default=["11","21","23"])
    
    # sampling strategy
    parser.add_argument("--nearfar_annealing", type=int, default=0)
    parser.add_argument("--update_annealing_list", type=int, action="append")
    parser.add_argument("--n_steps", type=int, default=2000)
    
    # FreeNeRF
    parser.add_argument("--freq_reg_mask", type=int, default=0)
    parser.add_argument("--freq_reg_end", type=int, default=45000) # int(0.9 * Config.max_steps)
    parser.add_argument("--max_vis_freq_ratio", type=float, default=None)
    ...
    parser.add_argument("--TV_weight_app", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--Occ_reg_weight", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--reg_range", type=int, default=10,
                        help='Occ reg range')
