...
class YourOwnDataset(Dataset):
    def __init__(self, datadir, split='train', downsample=1.0, is_stack=False, N_vis=-1):
        ...
        # self.scene_bbox = torch.tensor([[-1.5, -1.5, -1.5], [1.5, 1.5, 1.5]]) # default
        self.scene_bbox = torch.tensor([[0.4, 0.4, 0.4], [2.8, 2.8, 2.8]])
        ...
        self.white_bg = True
        # self.near_far = [0.1,100.0] # default
    ...
    def read_meta(self):
        ...
        for i in tqdm(idxs, desc=f'Loading data {self.split} ({len(idxs)})'):#img_list:#
            ...
            image_path = os.path.join(self.root_dir, f"{frame['file_path']}.png" if frame['file_path'].endswith('.png') else f"{frame['file_path']}.jpg")
